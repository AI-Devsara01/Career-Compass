...
TECH_ROLES = {
    ...
    "Cloud Engineer": {
     ...
     "DevOps Engineer": {
        "skills": ["ci/cd", "docker", "kubernetes", "jenkins", "ansible", "terraform",
                 "prometheus", "grafana", "linux", "bash scripting", "python scripting",
                 "aws", "azure", "google cloud", "monitoring", "logging"],
        "keywords": ["infrastructure as code", "site reliability engineering", "sre",
                   "configuration management", "auto scaling", "load balancing"]
    },
    "Blockchain Developer": {
        "skills": ["solidity", "ethereum", "smart contracts", "hyperledger", "cryptography",
                 "distributed systems", "web3", "truffle", "hardhat", "consensus algorithms",
                 "tokenomics", "defi", "nfts"],
        "keywords": ["dapps", "decentralized applications", "erc20", "erc721", "ipfs",
                   "metamask", "wallet integration"]
    },
    "UI/UX Designer": {
        "skills": ["wireframing", "prototyping", "figma", "adobe xd", "sketch", "user research",
                 "usability testing", "interaction design", "information architecture",
                 "visual design", "typography", "color theory", "responsive design"],
        "keywords": ["design thinking", "human-centered design", "user flows", "mockups",
                   "design systems", "accessibility", "a/b testing"]
    },
    "Product Manager": {
        "skills": ["product strategy", "roadmapping", "agile", "scrum", "kanban", "market research",
                 "competitive analysis", "user stories", "prioritization", "metrics", "kpis",
                 "stakeholder management", "customer development"],
        "keywords": ["product lifecycle", "mvp", "go-to-market", "customer discovery",
                   "business model canvas", "lean startup", "growth hacking"]
    },
    "Software Engineer": {
        "skills": ["java", "python", "c++", "c#", "data structures", "algorithms",
                 "software architecture", "design patterns", "debugging", "testing",
                 "version control", "object-oriented programming", "system design"],
        "keywords": ["clean code", "refactoring", "code review", "technical debt",
...
def analyze_resume(file_path):
    ...
    # 🔽 Limit to top 2 roles here
    top_2_results = analysis_results[:2]

    return {
        "sample_text": resume_text[:300] + "...",
        "analysis": top_2_results,  # Use only top 2 roles
        "ats_score": ats_score,
...
def generate_console_report(analysis_results, ats_score, top_n=3):
    ...
    if "certifications" in TECH_ROLES[top_role]:
