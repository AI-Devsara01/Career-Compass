...
# Define keywords for each tech role (expanded)
ROLE_KEYWORDS = {
    "AI/ML Engineer": ["machine learning", "deep learning", "tensorflow", "pytorch", "AI", "ML", "scikit-learn", "model training"],
    "Data Scientist": ["data analysis", "python", "statistics", "pandas", "numpy", "visualization", "regression", "EDA"],
    "Cloud Engineer": ["aws", "azure", "gcp", "cloud", "devops", "kubernetes", "docker"],
    "Cybersecurity Analyst": ["cybersecurity", "network", "threat", "vulnerability", "security", "encryption", "firewall"],
    "Full Stack Developer": ["javascript", "react", "node", "backend", "frontend", "django", "flask", "express"],
    "DevOps Engineer": ["CI/CD", "jenkins", "docker", "kubernetes", "ansible", "terraform", "monitoring"],
    "Data Engineer": ["big data", "spark", "hadoop", "etl", "pipeline", "data warehouse", "airflow"],
    "Mobile App Developer": ["android", "ios", "flutter", "react native", "kotlin", "swift"],
    "Software Engineer": ["java", "c++", "python", "algorithms", "system design", "oop"],
    "Product Manager": ["agile", "roadmap", "stakeholders", "market research", "user stories", "product"]
}
...
SKILL_RESOURCES = {
    ...
    "flutter": "https://docs.flutter.dev/learn",
