...
# Updated extract_text function with pdfplumber for PDFs
...
def extract_text(file_path):
    ...
    print(f"Extracted text from resume: {text[:500]}")  # Debugging line to show the first 500 characters of the extracted text
    return text.lower()
